    ...
    public void createSession(SessionInfo sessionInfo) {
        ...
        redisTemplate.execute((RedisCallback<Object>) connection -> {
            try {
                ...
                connection.stringCommands().setEx(sessionKeyBytes,
                        Duration.ofHours(sessionProperties.expirationHours()).toSeconds(), sessionValueBytes);
                ...
                connection.keyCommands().expire(userSessionKeyBytes,
                        Duration.ofHours(sessionProperties.expirationHours()).toSeconds());
