...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleMissingParameterException(MissingServletRequestParameterException e,
            HttpServletRequest request) {
    ...
    public ResponseEntity<ExceptionResponse> handleTypeMismatchException(MethodArgumentTypeMismatchException e,
            HttpServletRequest request) {
        // ExceptionType에 정의된 기본 메시지에 구체적인 파라미터 정보 추가
        String detailedMessage = String.format("%s (파라미터: %s)",
    ...
    public ResponseEntity<ExceptionResponse> handleGeneralException(Exception e, HttpServletRequest request) {
        logError(request, e, INTERNAL_SERVER_ERROR);
        return ResponseEntity.status(INTERNAL_SERVER_ERROR)
                .body(ExceptionResponse.of(ExceptionType.INTERNAL_SERVER_ERRORS));
    }
